...
def seed_users():
    ...
    db.session.add(User(first_name="Tom", last_name="Katt", email="Katt@horizon.com", hashed_password=generate_password_hash(f"Katt{password_add}"), role="Mentor", profile_photo="https://horizons-aa.s3.us-east-2.amazonaws.com/headshots/tom-mentor.jpg"))
